                ...
                '<div class="col-12 col-md-4 card card-animal p-1" id="swipe-card">' +
                    '<div class="card-body">' +
                        ...
                        '<div class="card-animal-info d-grid g-2 mt-2">' +
                            '<p class="corpo corpo-sm text-muted mt-2" style="font-size: clamp(0.9rem, 0.9vw, 0.9rem)">' + (a.especie || '') + ': ' + (a.raca || '') + ' | ' + (a.idade_aprox || '') + ' anos | ' + (a.sexo || '') + '</p>' +
                            '<p class="corpo corpo-sm text-muted mt-2" style="font-size: clamp(0.9rem, 0.9vw, 0.9rem)">' + (a.descricao || '') + '</p>' +
                        '</div>' +
                        '<div class="card-animal-localizacao  mt-2">' +
                            '<img src="./assets/imgs/icons/mapa.svg"></img>' +
                            '<p class="corpo corpo-sm text-muted mt-3" style="font-size: clamp(0.9rem, 0.9vw, 0.9rem)">' + nomeInst + (endereco ? ' - ' + endereco : '') + '</p>' +
                        '</div>' +
