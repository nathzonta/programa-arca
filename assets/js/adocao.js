...
function renderCard(index) {
    ...
    buscarAnimalPorId(animal.id).then(function (a) {
        ...
        buscarInstituicaoPorId(a.fk_instituicao).then(function (i) {
            ...
            $container.html(
                '<div class="col-xl-3 col-lg-5 col-md-6 col-sm-8 col-12 card card-animal p-1" id="swipe-card">' +
                    '<div class="card-body">' +
                        ...
                        '<div class="card-animal-info d-grid g-2 mt-2">' +
                            '<p class="corpo corpo-sm text-muted mt-2" style="font-size: clamp(1rem, 1vw, 1.2rem)">' + (a.especie || '') + ': ' + (a.raca || '') + ' | ' + (a.idade_aprox || '') + ' anos</p>' +
